...
-the residual plot doesn’t resemble random scatter around the horizontal line,the resideual near the boundaries are positive and the middle is negative, suggesting a lack of model fit, the relation could be quadratic.
...
-Since p-value is greater than 0.05, which is not statistically significant. There is no strong evidence that the null hypothesis is wrong, and no effect was observed.
