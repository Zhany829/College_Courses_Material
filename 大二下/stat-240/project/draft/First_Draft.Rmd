...
In this project, we plan to answer the question: 
...
- country-year: Name of the country connected with slash and corresponding year (1985-2016)
- HDI for year: Human Development  Index for a specific year (1985-2016)
- gdp_for_year: GDP of a country for a specific year
...
cf
```
The slope is 0.0001753973, and the coefficient is 0.3175026, so with the increase of gdp per capita, the suicide rate will also increase. 
...
### The relationship between different genders and their suicide rates.
