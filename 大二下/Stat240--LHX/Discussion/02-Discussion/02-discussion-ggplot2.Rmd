...
## Group Name 319C (use the assigned group name)

## Members Present
**Yuhan Dai**, Haoxuan Lu, Christopher Liou
...
ggplot(planets, aes(x=radius,y=mass)) +
  ...
  scale_y_log10() +
  scale_x_log10() +
  ## using smoothing method "linear smooth" and display the result
  geom_smooth(method="lm") +
  ## split the data with respects to method types
  facet_wrap(~method) +
