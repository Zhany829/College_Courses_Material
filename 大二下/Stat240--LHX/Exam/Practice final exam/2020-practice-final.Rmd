...
- Given a sample, a test statistic, and the test statistic’s sampling distribution, the p-value is the probability you observed the test statistic that was observed or a test statistic more extreme in the direction of the alternative hypothesis under the assumption the null hypothesis is true.
